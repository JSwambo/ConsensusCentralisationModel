...
class Blockchain():
	...
	# def __init__(self, db_path, start_from_genesis = True):
		# if start_from_genesis:
		# 	self.clear_blockchain_data()
	...
	# def insert_data_point(self, block_height, network_hash_rate, block_reward, tx_fees, difficulty, block_time):
	# 	self.db.insert({
	...
	# def search_by_block_height(self, block_height):
		# return self.db.get(Query().block_height == block_height)

	# def clear_blockchain_data(self, db_path):
	# 	os.remove(db_path)